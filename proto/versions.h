 ...
 */
extern int version_1(sock_t socket, uint8_t method, StatusCallback *callback);
#endif
 ...
 * Negotiate the method code with the server and pass the control to the respective method handler.
 */
extern int version_2(sock_t socket, uint8_t method, StatusCallback *callback);
#endif
 ...
 * Negotiate the method code with the server and pass the control to the respective method handler.
 */
extern int version_3(sock_t socket, uint8_t method, StatusCallback *callback);
#endif
