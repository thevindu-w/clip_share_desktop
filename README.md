...
| `udp_port` | The UDP port on which the server listens for network scan requests. (Refer to the corresponding configuration value of the server) | UDP port number used for the server (1 - 65535) | `4337` |
...
| `max_file_count` | The maximum number of files that can be received with the Get Files operation. | Any integer between 1 and 4294967294 inclusive. | 4294967294 |
